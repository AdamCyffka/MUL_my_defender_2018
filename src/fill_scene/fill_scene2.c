...
{
    wave1.buttons[option] = new_button("buttonoption.png", (sfVector2f) {0, 0},
...
void fill_scene_wave1d(game_scene_t wave1)
{
    ...
    (sfIntRect) {0, 0, 1920, 1080});
    wave1.buttons[t1] = new_button("t1button.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
    wave1.buttons[t2] = new_button("t2button.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
    wave1.buttons[t3] = new_button("t3button.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
