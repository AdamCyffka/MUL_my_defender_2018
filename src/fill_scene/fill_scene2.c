...
{
    wave1.buttons[option] = new_button("assets/buttonsettings.png",
...
void fill_scene_wave1b(game_scene_t wave1)
{
    ...
    wave1.objs[arrow2] = new_object("assets/arrow.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave1.objs[arrow3] = new_object("assets/arrow.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave1.objs[arrow4] = new_object("assets/arrow.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave1.objs[arrow5] = new_object("assets/arrow.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 20, 20}, 0);
...
void fill_scene_wave1a(game_scene_t wave1)
{
    ...
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 100, 100}, 0);
    wave1.objs[money] = new_object("assets/money.png", (sfVector2f) {0, 0},
