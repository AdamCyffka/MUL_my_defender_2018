...
void fill_scene_wave3e(game_scene_t wave3)
{
    ...
    (sfIntRect) {0, 0, 100, 100});
    wave3.buttons[t1] = new_button("tabutton.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100});
    wave3.buttons[t2] = new_button("tbbutton.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100});
    wave3.buttons[t3] = new_button("tcbutton.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100});
