...
void fill_scene_defeat(game_scene_t defeat)
{
    ...
    defeat.buttons[exit_b] = new_button("assets/exit.png", (sfVector2f) {0, 0},
...
void fill_scene_option(game_scene_t option)
{
    ...
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 1920, 1080});
    option.buttons[plus] = new_button("assets/plus.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
    option.buttons[minus] = new_button("assets/minus.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
    option.buttons[sound] = new_button("assets/sound.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
    option.buttons[mute] = new_button("assets/mute.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080});
}