...
{
    wave4.objs[arrow2] = new_object("assets/arrow.png", (sfVector2f) {750, 310},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave4.objs[arrow3] = new_object("assets/arrow.png", (sfVector2f) {400, 650},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave4.objs[arrow4] = new_object("assets/arrow.png", (sfVector2f) {800, 650},
    (sfIntRect) {0, 0, 20, 20}, 0);
    wave4.objs[arrow5] = new_object("assets/arrow.png", (sfVector2f) {1200, 650},
    (sfIntRect) {0, 0, 20, 20}, 0);
...
void fill_scene_wave4c(game_scene_t wave4)
{
    ...
    (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[arrow1] = new_object("assets/arrow.png", (sfVector2f) {750, 100},
    (sfIntRect) {0, 0, 20, 20}, 0);
