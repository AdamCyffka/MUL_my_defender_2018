...
{
    menu.objs[bg4] = new_object("background.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 5400, 1080}, 5.0);
    menu.objs[bg1] = new_object("backgroundback.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080}, 0);
    menu.objs[bg2] = new_object("backgroundcloud.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080}, 0);
    menu.objs[bg3] = new_object("backgroundfade.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 1920, 1080}, 0);
    menu.objs[title1] = new_object("maintitle.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100}, 0);
    menu.objs[title2] = new_object("maintitle2.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100}, 0);
    menu.objs[start] = new_object("start.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100}, 0);
}
