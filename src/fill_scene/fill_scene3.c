...
void fill_scene_wave2e(game_scene_t wave2)
{
    ...
    wave2.texts[0] = new_text("assets/font.ttf", "0", (sfVector2f) {0, 0}, 12);
    wave2.texts[1] = new_text("assets/font.ttf", "Wave 2/4",
    (sfVector2f) {0, 0}, 12);
    wave2.texts[2] = new_text("assets/font.ttf", "5", (sfVector2f) {0, 0}, 12);
}
...
void fill_scene_wave2a(game_scene_t wave2)
{
    ...
    wave2.objs[heart] = new_object("assets/buttonheart.png", (sfVector2f) {0, 0},
    (sfIntRect) {0, 0, 100, 100}, 0);
    wave2.objs[blanck_b] = new_object("assets/buttonblanck.png",
    (sfVector2f) {0, 0}, (sfIntRect) {0, 0, 200, 100}, 0);
    wave2.objs[money] = new_object("assets/money.png", (sfVector2f) {0, 0},
