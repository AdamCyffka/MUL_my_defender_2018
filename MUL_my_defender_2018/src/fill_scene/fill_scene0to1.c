...
{
    wave0.buttons[flag4] = new_button("assets/flag.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 100, 100});
    wave0.buttons[flag5] = new_button("assets/flag.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 100, 100});
...
void fill_scene_wave0a(game_scene_t wave0)
{
    ...
    wave0.buttons[flag1] = new_button("assets/flag.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 100, 100});
    wave0.buttons[flag2] = new_button("assets/flag.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 100, 100});
    wave0.buttons[flag3] = new_button("assets/flag.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 100, 100});
