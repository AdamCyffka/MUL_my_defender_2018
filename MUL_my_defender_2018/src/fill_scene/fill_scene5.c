...
{
    wave4.objs[arrow2] = new_object("assets/arrow.png",
    (sfVector2f) {800, 340}, (sfIntRect) {0, 0, 20, 20}, 0);
    wave4.objs[arrow3] = new_object("assets/arrow.png",
    (sfVector2f) {460, 700}, (sfIntRect) {0, 0, 20, 20}, 0);
    wave4.objs[arrow4] = new_object("assets/arrow.png",
...
{
    wave4.objs[enemy13] = new_object("assets/enemy.png",
    (sfVector2f) {950, -390}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy14] = new_object("assets/enemy.png",
    (sfVector2f) {950, -420}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy15] = new_object("assets/enemy.png",
    (sfVector2f) {950, -450}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy16] = new_object("assets/enemy.png",
    (sfVector2f) {950, -480}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy17] = new_object("assets/enemy.png",
    (sfVector2f) {950, -510}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy18] = new_object("assets/enemy.png",
    (sfVector2f) {950, -540}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy19] = new_object("assets/enemy.png",
    (sfVector2f) {950, -570}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy20] = new_object("assets/enemy.png",
    (sfVector2f) {950, -600}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[arrow1] = new_object("assets/arrow.png",
...
{
    wave4.objs[enemy4] = new_object("assets/enemy.png",
    (sfVector2f) {950, -120}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy5] = new_object("assets/enemy.png",
    (sfVector2f) {950, -150}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy6] = new_object("assets/enemy.png",
    (sfVector2f) {950, -180}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy7] = new_object("assets/enemy.png",
    (sfVector2f) {950, -210}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy8] = new_object("assets/enemy.png",
    (sfVector2f) {950, -240}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy9] = new_object("assets/enemy.png",
    (sfVector2f) {950, -270}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy10] = new_object("assets/enemy.png",
    (sfVector2f) {950, -300}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy11] = new_object("assets/enemy.png",
    (sfVector2f) {950, -330}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy12] = new_object("assets/enemy.png",
...
void fill_scene_wave4a(game_scene_t wave4)
{
    ...
    wave4.objs[enemy1] = new_object("assets/enemy.png",
    (sfVector2f) {950, -30}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy2] = new_object("assets/enemy.png",
    (sfVector2f) {950, -60}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave4.objs[enemy3] = new_object("assets/enemy.png",
