...
{
    wave1.objs[trap3] = new_object("assets/trap.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 70, 70}, 0);
    wave1.objs[trap4] = new_object("assets/trap.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 70, 70}, 0);
    wave1.objs[trap5] = new_object("assets/trap.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 70, 70}, 0);
...
void fill_scene_wave1b(game_scene_t wave1)
{
    ...
    wave1.objs[trap1] = new_object("assets/trap.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 70, 70}, 0);
    wave1.objs[trap2] = new_object("assets/trap.png",
    (sfVector2f) {-100, -100}, (sfIntRect) {0, 0, 70, 70}, 0);
...
void fill_scene_wave1a(game_scene_t wave1)
{
    ...
    wave1.objs[enemy1] = new_object("assets/enemy.png",
    (sfVector2f) {950, -30}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave1.objs[enemy2] = new_object("assets/enemy.png",
    (sfVector2f) {950, -60}, (sfIntRect) {0, 0, 23, 23}, 0);
    wave1.objs[enemy3] = new_object("assets/enemy.png",
